...
<main>
    <section>
        ...
        <form action="index.php?action=update" method="post">
            ...
            <input type="text" id="nom" name="nom" value="<?= SecurityUtils::sanitizeInput($userInfo['nom']); ?>" required>
            <?php if (isset($data['errors']['nom'])) : ?>
                <p class="error-message"><?php echo $data['errors']['nom']; ?></p>
            <?php endif; ?>
            <label for="prenom">Prénom:</label>
            <input type="text" id="prenom" name="prenom" value="<?= SecurityUtils::sanitizeInput($userInfo['prenom']); ?>" required>
            ...
            <input type="text" id="adresseInput" name="adresse" required value="<?= SecurityUtils::sanitizeInput($userInfo['adresse']); ?>" required>
            ...
            <input type="email" id="email" name="email" value="<?= SecurityUtils::sanitizeInput($userInfo['email']); ?>" required>
